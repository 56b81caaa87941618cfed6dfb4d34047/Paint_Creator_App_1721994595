...
*/
Vue.component("simple_footer_component_1721994596", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Unleash your inner artist with Painter's Palette, the ultimate platform for creating custom paints tailored to your unique vision. Explore a world of vibrant colors and textures, and let your creativity flow onto the canvas.
                    </div>
                </div>
            </div>
        </footer> 
